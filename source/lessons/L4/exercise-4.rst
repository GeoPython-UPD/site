...
.. admonition:: Start your assignment
    ...
    **You can start working on your copy of Exercise 4 by** `accepting the GitHub Classroom assignment <https://classroom.github.com/a/C74kKDuT>`__.

You can also take a look at the template repository for `Exercise 4 on GitHub <https://github.com/NIGS-GeoPython-2023/exercise-4>`__ (does not require logging in).
