...
.. admonition:: Start your assignment
    ...
    **You can start working on your copy of Exercise 2 by** `accepting the GitHub Classroom assignment <https://classroom.github.com/a/lidLTKiq>`__.

You can also take a look at the template repository for `Exercise 2 on GitHub <https://github.com/NIGS-GeoPython-2023/Exercise-2>`__ (does not require logging in).
